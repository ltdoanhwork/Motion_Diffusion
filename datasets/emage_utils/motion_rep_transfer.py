...
import torch
import numpy as np
from datasets.emage_utils import rotation_conversions as rc
import os
import wget 
...
if not os.path.exists(smplx_model_dir):
    ...
    if not os.path.exists(smplx_model_file_path):
        ...
        wget.download(
            "https://huggingface.co/H-Liu1997/emage_evaltools/resolve/main/smplx_models/smplx/SMPLX_NEUTRAL_2020.npz",
